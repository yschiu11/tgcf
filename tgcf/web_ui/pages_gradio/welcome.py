...
def create_welcome_page():
    """Create and return the welcome page interface."""    
    with gr.Blocks() as welcome_page:
        gr.Markdown("# Welcome to tgcf 👋")
        
        # Logo
        gr.HTML("""
            <p align="center">
            <img src="https://user-images.githubusercontent.com/66209958/115183360-3fa4d500-a0f9-11eb-9c0f-c5ed03a9ae17.png" 
                 alt="tgcf logo" width=120>
            </p>
        """)
...
What are you waiting for? Star the repo and click Watch to recieve updates.
        ...
        gr.Warning("Please press Save after changing any config.")
    
    return welcome_page


if __name__ == "__main__":
    # For testing this page standalone
